...
const CourseCard = ({ course }) => {
  return (
    <div className="inline-block mt-4 bg-white shadow-md rounded-xl p-4 max-w-[300px] mx-2 transform transition duration-300 hover:-translate-y-4 dark:bg-waikawa-900 dark:text-white">
