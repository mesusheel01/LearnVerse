...
const Navbar = () => {
    ...
    return (
        <>
        <nav className="flex justify-between items-center px-6 py-6 sm:px-10 md:px-14 lg:px-16 text-sm sm:text-base md:text-lg">
            {/* Logo */}
            ...
            {/* liveSearch function */}
            <div className='w-[30vh] flex gap-1'>
                <input
                    value={liveInput}
                    ref={inputRef}
                    type='text'
                    ...
                    '
                />
                <CiSearch onClick={giveRefToInput} className='text-waikawa-200 text-xl mt-1 hover:text-2xl transition-all duration-200 hover:mt-0' />
            </div>
            {/* Links and Buttons */}
            <div className="flex gap-3 font-aclonica text-[.7rem]  md:text-[.8rem] items-center">
                {/* user Info section */}
                <div className='text-lg hover:text-waikawa-600 transition-all duration-300 text-waikawa-400'>
                    <FaUserGraduate className='hover:-translate-y-1 transition-all duration-200' />
                </div>
                <button
                    onClick={toggleTheme}
            ...
            <div className='absolute top-[10.8vh] w-full h-[1px] dark:bg-waikawa-600 light:text-waikawa-950 '>
            </div>
        </>
    )
}
